...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fueltippedtrancecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fueltippedtrancecoin-tx [options] <hex-tx> [commands]  Update hex-encoded fueltippedtrancecoin transaction\n" +
            "or:     fueltippedtrancecoin-tx [options] -create [commands]   Create hex-encoded fueltippedtrancecoin transaction\n" +
            "\n";
