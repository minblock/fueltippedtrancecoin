...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Flyson 3 or 4";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586172456, 1780069, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x23051f6d9d74b0b4ce3a4f2dc8f1eb00924c412e8394c577bb9d6c48dc1a1b68"));
        assert(genesis.hashMerkleRoot == uint256S("0x571fdc97079d02d256e95f00a2bcb0b49704ef48a45886d115151aa279c2c070"));
        ...
        vSeeds.emplace_back("seed-a.fueltippedtrancecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.fueltippedtrancecointools.com");
        vSeeds.emplace_back("dnsseed.fueltippedtrancecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 654608, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xda3a6cc21d6147d5896ab7263f41987d866e67d1dce5647a5e819d645acfaaf1"));
        assert(genesis.hashMerkleRoot == uint256S("0x571fdc97079d02d256e95f00a2bcb0b49704ef48a45886d115151aa279c2c070"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.fueltippedtrancecointools.com");
        vSeeds.emplace_back("seed-b.fueltippedtrancecoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x07efa160eedeeaa3d977d9a442e03d0bd23a50904a6fc56f462c11d02f2e6080"));
        assert(genesis.hashMerkleRoot == uint256S("0x571fdc97079d02d256e95f00a2bcb0b49704ef48a45886d115151aa279c2c070"));
