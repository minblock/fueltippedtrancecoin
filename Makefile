...
pkgdatadir = $(datadir)/fueltippedtrancecoin
pkgincludedir = $(includedir)/fueltippedtrancecoin
pkglibdir = $(libdir)/fueltippedtrancecoin
pkglibexecdir = $(libexecdir)/fueltippedtrancecoin
...
ACLOCAL = ${SHELL} /fueltippedtrancecoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /fueltippedtrancecoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /fueltippedtrancecoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /fueltippedtrancecoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = fueltippedtrancecoin-cli
BITCOIN_DAEMON_NAME = fueltippedtrancecoind
BITCOIN_GUI_NAME = fueltippedtrancecoin-qt
BITCOIN_TX_NAME = fueltippedtrancecoin-tx
BITCOIN_WALLET_TOOL_NAME = fueltippedtrancecoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Fueltippedtrancecoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Fueltippedtrancecoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /fueltippedtrancecoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = fueltippedtrancecoin
PACKAGE_BUGREPORT = https://github.com/fueltippedtrancecoin-project/fueltippedtrancecoin/issues
PACKAGE_NAME = Fueltippedtrancecoin Core
PACKAGE_STRING = Fueltippedtrancecoin Core 0.18.1
PACKAGE_TARNAME = fueltippedtrancecoin
PACKAGE_URL = https://fueltippedtrancecoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /fueltippedtrancecoin
abs_srcdir = /fueltippedtrancecoin
abs_top_builddir = /fueltippedtrancecoin
abs_top_srcdir = /fueltippedtrancecoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /fueltippedtrancecoin/build-aux/install-sh
...
empty := 
space := $(empty) $(empty)
OSX_APP = Fueltippedtrancecoin-Qt.app
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Fueltippedtrancecoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Fueltippedtrancecoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Fueltippedtrancecoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Fueltippedtrancecoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
