# Support for Output Descriptors in Fueltippedtrancecoin Core

Since Fueltippedtrancecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Fueltippedtrancecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Fueltippedtrancecoin Core wallets, a convenience function `combo` is
