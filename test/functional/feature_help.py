...
"""Verify that starting fueltippedtrancecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fueltippedtrancecoin with -h for help text")
        ...
        self.log.info("Start fueltippedtrancecoin with -version for version information")
        ...
        self.log.info("Start fueltippedtrancecoind with -fakearg to make sure it does not start")
